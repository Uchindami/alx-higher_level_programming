...
class Square:
    ...
    @property
    def position(self):
        """since Size is private use getter to get the position"""
        return self.__position

    @position.setter
    def position(self, value):
        """since Size is private use setter to set the position"""
    ...
    def my_print(self):
        """Print our square with the # character. would have preferred the *"""
        if self.__size == 0:
            print("")
            return
